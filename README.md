...
This site hosts the freely available Saaho language datasets.

SAMTRAMOD Ver 1.0
Released 2026
Parallel corpus (en-sa) for training the Saho Machine Translation Model (SAMTRAMOD) by Jama Musse Jama.
